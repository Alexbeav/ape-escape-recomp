...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "ape-escape-",
    .project_root_env = "APE_ESCAPE_RECOMP_PROJECT_ROOT",
    .build_dir_env = "APE_ESCAPE_RECOMP_BUILD_DIR",
    .force_setup_env = "APE_ESCAPE_RECOMP_FORCE_SETUP",
    ...
    .exe_basename = "ape_escape__Recompiled",
    .prepare_note =
