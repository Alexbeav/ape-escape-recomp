# Ape Escape release feasibility
...
The supported serial set is $(@{ordinal=22; slug=ape-escape; title=Ape Escape; serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses
