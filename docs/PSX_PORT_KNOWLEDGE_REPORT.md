# Ape Escape knowledge report

- Date: 2026-08-31
- Retail identity: USA NTSC-U `SCUS-94423`
...
The source now uses `Ape_Escape_Recompiled` as the only setup executable name. The batch source
