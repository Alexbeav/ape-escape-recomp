...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/ape-escape-recomp/total)](https://github.com/Alexbeav/ape-escape-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/ape-escape-recomp/latest/total)](https://github.com/Alexbeav/ape-escape-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/ape-escape-recomp)](https://github.com/Alexbeav/ape-escape-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Ape Escape** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for Ape Escape.
...
Zip prefix for CI artifacts: `Ape-Escape-Recomp`.
...
The `v0.3.3` source uses `Ape_Escape_Recompiled` in CMake, the setup relaunch, and the packager.
